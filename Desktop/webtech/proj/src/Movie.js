  ...
  constructor(props){
    ...
    /*  movies: [{}],*/
      movies: [{id: 0, name: 'Interstellar', year: 2014, img: img1, description: 'A team of explorers travel through a wormhole in space in an attempt to ensure humanity survival.'},
               {id: 1, name: 'Alice in WonderLand', year: 2010, img: img2, description:'Nineteen-year-old Alice returns to the magical world from her childhood adventure, where she reunites with her old friends and learns of her true destiny: to end the Red Queens reign of terror.'},
     ...
     <div className="main"> 
        <div className="Left">
          <div className="menubar">
            <ul className="menuitems">
              <li onClick = {this.handleClickComedy}>Comedy</li>
              <li onClick = {this.handleClickRomance}>Romance</li>
              <li onClick = {this.handleClickThriller}>Thriller</li>
              <li onClick = {this.handleClickHorror}>Horror</li>
            </ul>
          </div>
        </div>
      ...
      <div className="Right">
        <div class="ui action left icon input" id="search">
          ...
          <button className="ui primary button" id="btn">Search</button>
        </div>
        <div className="login">
          <Login/>
        </div>
